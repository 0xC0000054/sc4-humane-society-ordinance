...
protected:
	...
	/**
	 * @brief Initializes any required city components.
	 *
	 * @param The cISC4City object.
	 * @return True on success; otherwise, false.
	*/
	virtual bool InitCityComponents(cISC4City& city);

	/**
	* @brief Shuts down any required city components.
	*
	* @return True on success; otherwise, false.
	*/
	virtual bool ShutdownCityComponents();
